...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Control Tentang Kami</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url() ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Konfigurasi Tentang Kami</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="box box-success">
                    <div class="box-header">
                        ...
                        <a href="<?= base_url('tentangkami/tambahprf') ?>" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> Data Profile</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                                ...
                                foreach ($profile->result() as $key => $prf) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center" style="white-space: nowrap;">
                                            <a href="<?= base_url('tentangkami/updateprf/' . $prf->id_profilesekolah) ?>" class="btn btn-primary btn-xs">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="<?= base_url('tentangkami/hapusprf/' . $prf->id_profilesekolah) ?>" class="btn btn-danger btn-xs konfirHapus">
            ...
            <div class="col-xs-12">
                <div class="box box-success">
                    <form action="<?= base_url('tentangkami/processvm/' . $svm->id_strukturvisimisi) ?>" method="POST">
                        <div class="box-header">
...
<div class="modal fade" id="change-struktur">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <form action="<?= base_url('tentangkami/changeStruktur') ?>" enctype="multipart/form-data" method="POST">
