                ...
                <div class="row row-cols-2 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 g-4">
                    <div class="col">
                        <div class="card text-center h-100 hover-shadow hover-zoom">
                            <div class="bg-image">
                                <img src="<?= site_url('assets/img/ptk/ptk-default.png') ?>" class="w-100" />
                            </div>
                            <div class="card-body">
                                <h5 class="card-title mb-0"><a href="javascript:;" data-mdb-toggle="modal" data-mdb-target="#detail-ptk">Akmar, S.Pd.SD</a></h5>
                                <p class="card-text">
                                    Kepala Sekolah
                                </p>
                            </div>
...
<!-- Modal Gallery -->
<div class="modal fade" id="detail-ptk" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content p-3">
            <div class="row">
                <div class="col-6 ms-auto me-auto">
                    <img src="<?= site_url('assets/img/ptk/ptk-default.png') ?>" class="img-fluid shadow-2-strong img-modal" alt="" />
                </div>
                <div class="col-sm-6 col-12 text-center text-sm-start mt-3 mt-sm-0">
                    <h6 class="mb-0">Nama</h6>
                    <p>Akmar, S.Pd.SD</p>
                    <h6 class="mb-0">NIP</h6>
                    <p>6402165154880001</p>
