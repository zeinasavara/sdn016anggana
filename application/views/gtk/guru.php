            ...
            <div class="mask" style="background-color: rgba(0, 0, 0, 0.6)">
                <div class="d-flex justify-content-center align-items-center h-100">
                    <div class="text-white">
                        ...
                        <h4 class="mb-3">Guru & Tenaga Kependidikan</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
                ...
                <div class="col-12 d-flex justify-content-center justify-content-lg-end justify-content-md-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Guru & Tenaga Kependidikan</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div class="content pb-3">
                ...
                <div class="row row-cols-2 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 g-4">
                    <?php foreach ($guru->result() as $key => $g) { ?>

                        <div class="col">
                            <div class="card text-center h-100 hover-shadow hover-zoom">
                                <div class="bg-image">
                                    <img src="<?= site_url('assets/img/ptk/' . $g->foto) ?>" alt="<?= $g->foto ?>" class="w-100" style="height: 250px;" />
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title mb-0"><a href="javascript:;" data-mdb-toggle="modal" data-mdb-target="#detail-ptk<?= $g->id_gtk ?>"><?= $g->nama ?></a></h5>
                                    <p class="card-text">
                                        <?= $g->jabatan ?>
                                    </p>
                                </div>
                        ...
                        <!-- Modal Gallery -->
                        <div class="modal fade" id="detail-ptk<?= $g->id_gtk ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content p-3">
                                    <div class="row">
                                        <div class="col-6 ms-auto me-auto">
                                            <img src="<?= site_url('assets/img/ptk/' . $g->foto) ?>" class="img-fluid shadow-2-strong img-modal" alt="<?= $g->foto ?>" />
                                        </div>
